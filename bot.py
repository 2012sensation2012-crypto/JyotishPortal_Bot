...
# Состояния бота
(STATE_START, STATE_SELECT_CITY, STATE_SELECT_TYPE, STATE_ENTER_YEAR, STATE_ENTER_MONTH, STATE_SHOW_RESULTS) = range(6)
...
async def enter_month(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        if month < 1 or month > 12:
            await update.message.reply_text("❌ Некорректный месяц. Введите число от 1 до 12.")
            return STATE_ENTER_MONTH
